...
public class LoggingAspec {
    ...
    @Pointcut("execution(* com.dml.topup.controller..*(..))")
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (log.isInfoEnabled()) {
            // log.info(String.format("%s {} {} with argument[s] = {}", Constants.REQUEST_LOG), uid, joinPoint.getSignature().getName(), Arrays.toString(joinPoint.getArgs()));
            log.info("{"
                    + "\"action\"" + ":" + "\"Topup\", "
                    + "\"event\"" + ":" + "\"Request\", "
                    + "\"uid\"" + ":" + "\"" + uuid + "\", "
