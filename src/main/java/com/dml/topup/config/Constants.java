...
public final class Constants {
    ...
    public static final String MCI_REST_GET_TRANSACTION_INQUIRY = "mci.rest.get.transaction.inquiry";
    public static final String MTN_RIGHTEL_REST_GET_TRANSACTION_INQUIRY = "mtn.rightel.rest.get.transaction.inquiry";
